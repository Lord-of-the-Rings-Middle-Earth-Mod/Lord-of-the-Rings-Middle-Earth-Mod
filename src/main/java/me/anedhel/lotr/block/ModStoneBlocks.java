...
public class ModStoneBlocks {
    ...
    // CHALK BLOCKS - Following exact blueslate pattern
	...
	public static final BlockFamily CHALK_BRICK_FAMILY = BlockFamilies.register(CHALK_BRICKS)
			...
			.group("stone").unlockCriterionName("has_stone_bricks").build();
	...
	public static final BlockFamily CRACKED_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_CHALK_BRICKS)
			...
			.group("stone").unlockCriterionName("has_cracked_stone_bricks").build();
