...
public class ModStoneBlocks {
    ...
    public static final Block BLUESLATE_STAIRS = registerBlock("blueslate_stairs",
            new StairsBlock(BLUESLATE.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
    ...
    public static final Block BLUESLATE_BUTTON = registerBlock("blueslate_button",
            new ButtonBlock(BlockSetType.STONE, 10, AbstractBlock.Settings.copy(Blocks.STONE_BUTTON)));
	...
	public static final Block MOSSY_BLUESLATE_STAIRS = registerBlock("mossy_blueslate_stairs",
			new StairsBlock(MOSSY_BLUESLATE.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BLUESLATE_STAIRS = registerBlock("overgrown_blueslate_stairs",
			new StairsBlock(OVERGROWN_BLUESLATE.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
    ...
    public static final Block COBBLED_BLUESLATE_STAIRS = registerBlock("cobbled_blueslate_stairs",
            new StairsBlock(COBBLED_BLUESLATE.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_COBBLED_BLUESLATE_STAIRS = registerBlock("mossy_cobbled_blueslate_stairs",
			new StairsBlock(MOSSY_COBBLED_BLUESLATE.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cobbled_blueslate_brick_stairs",
			new StairsBlock(COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	public static final Block COBBLED_BLUESLATE_BRICK_SLAB = registerBlock("cobbled_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_SLAB)));
	public static final Block COBBLED_BLUESLATE_BRICK_WALL = registerBlock("cobbled_blueslate_brick_wall",
	...
	public static final Block CRACKED_COBBLED_BLUESLATE_BRICKS = registerBlock("cracked_cobbled_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.COBBLESTONE)));
	public static final Block CRACKED_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	public static final Block CRACKED_COBBLED_BLUESLATE_BRICK_SLAB = registerBlock("cracked_cobbled_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_SLAB)));
	public static final Block CRACKED_COBBLED_BLUESLATE_BRICK_WALL = registerBlock("cracked_cobbled_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_WALL)));
	...
	public static final Block MOSSY_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_cobbled_blueslate_brick_stairs",
			new StairsBlock(MOSSY_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_mossy_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_cobbled_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_overgrown_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(MOSSY_BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_mossy_bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_overgrown_bronze_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("silver_cobbled_blueslate_brick_stairs",
			new StairsBlock(SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_silver_cobbled_blueslate_brick_stairs",
			new StairsBlock(MOSSY_SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_mossy_silver_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_silver_cobbled_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_overgrown_silver_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("gold_cobbled_blueslate_brick_stairs",
			new StairsBlock(GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_gold_cobbled_blueslate_brick_stairs",
			new StairsBlock(MOSSY_GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_mossy_gold_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_gold_cobbled_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_overgrown_gold_cobbled_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
    ...
    public static final Block BLUESLATE_BRICK_STAIRS = registerBlock("blueslate_brick_stairs",
            new StairsBlock(BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BLUESLATE_BRICK_STAIRS = registerBlock("cracked_blueslate_brick_stairs",
			new StairsBlock(CRACKED_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
    ...
    public static final Block BLUESLATE_TILES_STAIRS = registerBlock("blueslate_tiles_stairs",
            new StairsBlock(BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BLUESLATE_TILES_STAIRS = registerBlock("cracked_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BLUESLATE_TILES_STAIRS = registerBlock("mossy_blueslate_tiles_stairs",
			new StairsBlock(MOSSY_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BLUESLATE_TILES_STAIRS = registerBlock("cracked_mossy_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BLUESLATE_TILES_STAIRS = registerBlock("overgrown_blueslate_tiles_stairs",
			new StairsBlock(OVERGROWN_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BLUESLATE_TILES_STAIRS = registerBlock("cracked_overgrown_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("bronze_blueslate_tiles_stairs",
			new StairsBlock(BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("cracked_bronze_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("mossy_bronze_blueslate_tiles_stairs",
			new StairsBlock(MOSSY_BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("cracked_mossy_bronze_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("overgrown_bronze_blueslate_tiles_stairs",
			new StairsBlock(OVERGROWN_BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_BLUESLATE_TILES_STAIRS = registerBlock("cracked_overgrown_bronze_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block SILVER_BLUESLATE_TILES_STAIRS = registerBlock("silver_blueslate_tiles_stairs",
			new StairsBlock(SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_BLUESLATE_TILES_STAIRS = registerBlock("cracked_silver_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_BLUESLATE_TILES_STAIRS = registerBlock("mossy_silver_blueslate_tiles_stairs",
			new StairsBlock(MOSSY_SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_BLUESLATE_TILES_STAIRS = registerBlock("cracked_mossy_silver_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_BLUESLATE_TILES_STAIRS = registerBlock("overgrown_silver_blueslate_tiles_stairs",
			new StairsBlock(OVERGROWN_SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_BLUESLATE_TILES_STAIRS = registerBlock("cracked_overgrown_silver_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block GOLD_BLUESLATE_TILES_STAIRS = registerBlock("gold_blueslate_tiles_stairs",
			new StairsBlock(GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_BLUESLATE_TILES_STAIRS = registerBlock("cracked_gold_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_BLUESLATE_TILES_STAIRS = registerBlock("mossy_gold_blueslate_tiles_stairs",
			new StairsBlock(MOSSY_GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_BLUESLATE_TILES_STAIRS = registerBlock("cracked_mossy_gold_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_BLUESLATE_TILES_STAIRS = registerBlock("overgrown_gold_blueslate_tiles_stairs",
			new StairsBlock(OVERGROWN_GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_BLUESLATE_TILES_STAIRS = registerBlock("cracked_overgrown_gold_blueslate_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_BLUESLATE_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
    ...
    public static final Block BLUESLATE_PILLAR = registerBlock("blueslate_pillar",
            new ModPillarBlock(AbstractBlock.Settings.copy(Blocks.STONE)));
    ...
    public static final Block BLUESLATE_PAVEMENT_STAIRS = registerBlock("blueslate_pavement_stairs",
            new StairsBlock(BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BLUESLATE_PAVEMENT_STAIRS = registerBlock("mossy_blueslate_pavement_stairs",
			new StairsBlock(MOSSY_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_mossy_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BLUESLATE_PAVEMENT_STAIRS = registerBlock("overgrown_blueslate_pavement_stairs",
			new StairsBlock(OVERGROWN_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("bronze_blueslate_pavement_stairs",
			new StairsBlock(BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_bronze_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("mossy_bronze_blueslate_pavement_stairs",
			new StairsBlock(MOSSY_BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_mossy_bronze_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("overgrown_bronze_blueslate_pavement_stairs",
			new StairsBlock(OVERGROWN_BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_bronze_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("silver_blueslate_pavement_stairs",
			new StairsBlock(SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_silver_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("mossy_silver_blueslate_pavement_stairs",
			new StairsBlock(MOSSY_SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_mossy_silver_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("overgrown_silver_blueslate_pavement_stairs",
			new StairsBlock(OVERGROWN_SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_silver_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("gold_blueslate_pavement_stairs",
			new StairsBlock(GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_gold_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("mossy_gold_blueslate_pavement_stairs",
			new StairsBlock(MOSSY_GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_mossy_gold_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("overgrown_gold_blueslate_pavement_stairs",
			new StairsBlock(OVERGROWN_GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_BLUESLATE_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_gold_blueslate_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_BLUESLATE_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block FANCY_BLUESLATE_BRICKS = registerBlock("fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("fancy_blueslate_brick_stairs",
			new StairsBlock(FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block FANCY_BLUESLATE_BRICK_SLAB = registerBlock("fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block FANCY_BLUESLATE_BRICK_WALL = registerBlock("fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_FANCY_BLUESLATE_BRICKS = registerBlock("mossy_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_fancy_blueslate_brick_stairs",
			new StairsBlock(MOSSY_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("mossy_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_FANCY_BLUESLATE_BRICK_WALL = registerBlock("mossy_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_mossy_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_mossy_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_mossy_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_mossy_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_MOSSY_FANCY_BLUESLATE_BRICK_WALL)
	...
	public static final Block OVERGROWN_FANCY_BLUESLATE_BRICKS = registerBlock("overgrown_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_fancy_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("overgrown_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_FANCY_BLUESLATE_BRICK_WALL = registerBlock("overgrown_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_overgrown_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_overgrown_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_overgrown_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_FANCY_BLUESLATE_BRICK_WALL)
	...
	public static final Block BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("mossy_bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("mossy_bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("mossy_bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_mossy_bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_mossy_bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_mossy_bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_mossy_bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_MOSSY_BRONZE_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_bronze_fancy_bricks").build();

	public static final Block OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("overgrown_bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("overgrown_bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("overgrown_bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_overgrown_bronze_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_bronze_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_overgrown_bronze_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_overgrown_bronze_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_BRONZE_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_bronze_fancy_bricks").build();

	public static final Block SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("silver_fancy_blueslate_brick_stairs",
			new StairsBlock(SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_silver_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("mossy_silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_silver_fancy_blueslate_brick_stairs",
			new StairsBlock(MOSSY_SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("mossy_silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("mossy_silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_mossy_silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_mossy_silver_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_mossy_silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_mossy_silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_MOSSY_SILVER_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_silver_fancy_bricks").build();

	public static final Block OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("overgrown_silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_silver_fancy_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("overgrown_silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("overgrown_silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_overgrown_silver_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_silver_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_overgrown_silver_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_overgrown_silver_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_SILVER_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_silver_fancy_bricks").build();

	public static final Block GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("gold_fancy_blueslate_brick_stairs",
			new StairsBlock(GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_gold_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("mossy_gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("mossy_gold_fancy_blueslate_brick_stairs",
			new StairsBlock(MOSSY_GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("mossy_gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("mossy_gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_mossy_gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_mossy_gold_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_mossy_gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_mossy_gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_MOSSY_GOLD_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_gold_fancy_bricks").build();

	public static final Block OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("overgrown_gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock("overgrown_gold_fancy_blueslate_brick_stairs",
			new StairsBlock(OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("overgrown_gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("overgrown_gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS = registerBlock("cracked_overgrown_gold_fancy_blueslate_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_gold_fancy_blueslate_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_SLAB = registerBlock("cracked_overgrown_gold_fancy_blueslate_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_WALL = registerBlock("cracked_overgrown_gold_fancy_blueslate_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICKS)
			.stairs(CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_GOLD_FANCY_BLUESLATE_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_gold_fancy_bricks").build();
    ...
    public static final Block CHALK_STAIRS = registerBlock("chalk_stairs",
            new StairsBlock(CHALK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_CHALK_STAIRS = registerBlock("mossy_chalk_stairs",
			new StairsBlock(MOSSY_CHALK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_CHALK_STAIRS = registerBlock("overgrown_chalk_stairs",
			new StairsBlock(OVERGROWN_CHALK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
    ...
    public static final Block COBBLED_CHALK_STAIRS = registerBlock("cobbled_chalk_stairs",
            new StairsBlock(COBBLED_CHALK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_COBBLED_CHALK_STAIRS = registerBlock("mossy_cobbled_chalk_stairs",
			new StairsBlock(MOSSY_COBBLED_CHALK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block COBBLED_CHALK_BRICKS = registerBlock("cobbled_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.COBBLESTONE)));
	public static final Block COBBLED_CHALK_BRICK_STAIRS = registerBlock("cobbled_chalk_brick_stairs",
			new StairsBlock(COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	public static final Block COBBLED_CHALK_BRICK_SLAB = registerBlock("cobbled_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_SLAB)));
	public static final Block COBBLED_CHALK_BRICK_WALL = registerBlock("cobbled_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_WALL)));
	...
	public static final Block CRACKED_COBBLED_CHALK_BRICKS = registerBlock("cracked_cobbled_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.COBBLESTONE)));
	public static final Block CRACKED_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	public static final Block CRACKED_COBBLED_CHALK_BRICK_SLAB = registerBlock("cracked_cobbled_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_SLAB)));
	public static final Block CRACKED_COBBLED_CHALK_BRICK_WALL = registerBlock("cracked_cobbled_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.COBBLESTONE_WALL)));
	...
	public static final Block MOSSY_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_cobbled_chalk_brick_stairs",
			new StairsBlock(MOSSY_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_cobbled_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(MOSSY_BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_bronze_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("silver_cobbled_chalk_brick_stairs",
			new StairsBlock(SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_silver_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_silver_cobbled_chalk_brick_stairs",
			new StairsBlock(MOSSY_SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_silver_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_silver_cobbled_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_silver_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("gold_cobbled_chalk_brick_stairs",
			new StairsBlock(GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_gold_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_gold_cobbled_chalk_brick_stairs",
			new StairsBlock(MOSSY_GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_gold_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_gold_cobbled_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_gold_cobbled_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_COBBLED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.COBBLESTONE_STAIRS)));
	...
	public static final Block CHALK_BRICK_STAIRS = registerBlock("chalk_brick_stairs",
			new StairsBlock(CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CHALK_BRICK_WALL = registerBlock("chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CHALK_BRICKS_FAMILY = BlockFamilies.register(CHALK_BRICKS)
	...
	public static final Block CRACKED_CHALK_BRICK_STAIRS = registerBlock("cracked_chalk_brick_stairs",
			new StairsBlock(CRACKED_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_CHALK_BRICK_STAIRS = registerBlock("mossy_chalk_brick_stairs",
			new StairsBlock(MOSSY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_CHALK_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_MOSSY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_CHALK_BRICK_STAIRS = registerBlock("overgrown_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_CHALK_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_OVERGROWN_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block BRONZE_CHALK_BRICK_STAIRS = registerBlock("bronze_chalk_brick_stairs",
			new StairsBlock(BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_CHALK_BRICK_STAIRS = registerBlock("cracked_bronze_chalk_brick_stairs",
			new StairsBlock(CRACKED_BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_CHALK_BRICK_STAIRS = registerBlock("mossy_bronze_chalk_brick_stairs",
			new StairsBlock(MOSSY_BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_bronze_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_CHALK_BRICK_STAIRS = registerBlock("overgrown_bronze_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_bronze_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block SILVER_CHALK_BRICK_STAIRS = registerBlock("silver_chalk_brick_stairs",
			new StairsBlock(SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_CHALK_BRICK_STAIRS = registerBlock("cracked_silver_chalk_brick_stairs",
			new StairsBlock(CRACKED_SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_CHALK_BRICK_STAIRS = registerBlock("mossy_silver_chalk_brick_stairs",
			new StairsBlock(MOSSY_SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_silver_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_CHALK_BRICK_STAIRS = registerBlock("overgrown_silver_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_silver_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block GOLD_CHALK_BRICK_STAIRS = registerBlock("gold_chalk_brick_stairs",
			new StairsBlock(GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_CHALK_BRICK_STAIRS = registerBlock("cracked_gold_chalk_brick_stairs",
			new StairsBlock(CRACKED_GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_CHALK_BRICK_STAIRS = registerBlock("mossy_gold_chalk_brick_stairs",
			new StairsBlock(MOSSY_GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_CHALK_BRICK_STAIRS = registerBlock("cracked_mossy_gold_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_CHALK_BRICK_STAIRS = registerBlock("overgrown_gold_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_CHALK_BRICK_STAIRS = registerBlock("cracked_overgrown_gold_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CHALK_TILES_STAIRS = registerBlock("chalk_tiles_stairs",
			new StairsBlock(CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_CHALK_TILES_STAIRS = registerBlock("cracked_chalk_tiles_stairs",
			new StairsBlock(CRACKED_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_CHALK_TILES_STAIRS = registerBlock("mossy_chalk_tiles_stairs",
			new StairsBlock(MOSSY_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_CHALK_TILES_STAIRS = registerBlock("cracked_mossy_chalk_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_CHALK_TILES_STAIRS = registerBlock("overgrown_chalk_tiles_stairs",
			new StairsBlock(OVERGROWN_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_CHALK_TILES_STAIRS = registerBlock("cracked_overgrown_chalk_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block BRONZE_CHALK_TILES_STAIRS = registerBlock("bronze_chalk_tiles_stairs",
			new StairsBlock(BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_CHALK_TILES_STAIRS = registerBlock("cracked_bronze_chalk_tiles_stairs",
			new StairsBlock(CRACKED_BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_CHALK_TILES_STAIRS = registerBlock("mossy_bronze_chalk_tiles_stairs",
			new StairsBlock(MOSSY_BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_CHALK_TILES_STAIRS = registerBlock("cracked_mossy_bronze_chalk_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_CHALK_TILES_STAIRS = registerBlock("overgrown_bronze_chalk_tiles_stairs",
			new StairsBlock(OVERGROWN_BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_CHALK_TILES_STAIRS = registerBlock("cracked_overgrown_bronze_chalk_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block SILVER_CHALK_TILES_STAIRS = registerBlock("silver_chalk_tiles_stairs",
			new StairsBlock(SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_CHALK_TILES_STAIRS = registerBlock("cracked_silver_chalk_tiles_stairs",
			new StairsBlock(CRACKED_SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_CHALK_TILES_STAIRS = registerBlock("mossy_silver_chalk_tiles_stairs",
			new StairsBlock(MOSSY_SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_CHALK_TILES_STAIRS = registerBlock("cracked_mossy_silver_chalk_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_CHALK_TILES_STAIRS = registerBlock("overgrown_silver_chalk_tiles_stairs",
			new StairsBlock(OVERGROWN_SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_CHALK_TILES_STAIRS = registerBlock("cracked_overgrown_silver_chalk_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block GOLD_CHALK_TILES_STAIRS = registerBlock("gold_chalk_tiles_stairs",
			new StairsBlock(GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_CHALK_TILES_STAIRS = registerBlock("cracked_gold_chalk_tiles_stairs",
			new StairsBlock(CRACKED_GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_CHALK_TILES_STAIRS = registerBlock("mossy_gold_chalk_tiles_stairs",
			new StairsBlock(MOSSY_GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_CHALK_TILES_STAIRS = registerBlock("cracked_mossy_gold_chalk_tiles_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_CHALK_TILES_STAIRS = registerBlock("overgrown_gold_chalk_tiles_stairs",
			new StairsBlock(OVERGROWN_GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_CHALK_TILES_STAIRS = registerBlock("cracked_overgrown_gold_chalk_tiles_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_CHALK_TILES.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CHALK_PAVEMENT_STAIRS = registerBlock("chalk_pavement_stairs",
			new StairsBlock(CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_chalk_pavement_stairs",
			new StairsBlock(CRACKED_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_chalk_pavement_stairs",
			new StairsBlock(MOSSY_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_mossy_chalk_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_chalk_pavement_stairs",
			new StairsBlock(OVERGROWN_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_chalk_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("bronze_chalk_pavement_stairs",
			new StairsBlock(BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_bronze_chalk_pavement_stairs",
			new StairsBlock(CRACKED_BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_bronze_chalk_pavement_stairs",
			new StairsBlock(MOSSY_BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_mossy_bronze_chalk_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_bronze_chalk_pavement_stairs",
			new StairsBlock(OVERGROWN_BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_bronze_chalk_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("silver_chalk_pavement_stairs",
			new StairsBlock(SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_silver_chalk_pavement_stairs",
			new StairsBlock(CRACKED_SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_silver_chalk_pavement_stairs",
			new StairsBlock(MOSSY_SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_mossy_silver_chalk_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_silver_chalk_pavement_stairs",
			new StairsBlock(OVERGROWN_SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_silver_chalk_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("gold_chalk_pavement_stairs",
			new StairsBlock(GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_gold_chalk_pavement_stairs",
			new StairsBlock(CRACKED_GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block MOSSY_GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_gold_chalk_pavement_stairs",
			new StairsBlock(MOSSY_GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_MOSSY_GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_mossy_gold_chalk_pavement_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block OVERGROWN_GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_gold_chalk_pavement_stairs",
			new StairsBlock(OVERGROWN_GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_overgrown_gold_chalk_pavement_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_CHALK_PAVEMENT.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	...
	public static final Block FANCY_CHALK_BRICKS = registerBlock("fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block FANCY_CHALK_BRICK_STAIRS = registerBlock("fancy_chalk_brick_stairs",
			new StairsBlock(FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block FANCY_CHALK_BRICK_SLAB = registerBlock("fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block FANCY_CHALK_BRICK_WALL = registerBlock("fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_FANCY_CHALK_BRICKS = registerBlock("cracked_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_FANCY_CHALK_BRICKS = registerBlock("mossy_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_fancy_chalk_brick_stairs",
			new StairsBlock(MOSSY_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_MOSSY_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_mossy_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_mossy_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_MOSSY_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_MOSSY_FANCY_CHALK_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_mossy_fancy_bricks").build();

	public static final Block OVERGROWN_FANCY_CHALK_BRICKS = registerBlock("overgrown_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_fancy_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			...
			new StairsBlock(CRACKED_OVERGROWN_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_overgrown_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_overgrown_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_OVERGROWN_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_FANCY_CHALK_BRICK_WALL)
			.group("stone").unlockCriterionName("has_cracked_overgrown_fancy_bricks").build();

	public static final Block BRONZE_FANCY_CHALK_BRICKS = registerBlock("bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock("bronze_fancy_chalk_brick_stairs",
			new StairsBlock(BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_BRONZE_FANCY_CHALK_BRICKS = registerBlock("cracked_bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_bronze_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_BRONZE_FANCY_CHALK_BRICKS = registerBlock("mossy_bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_bronze_fancy_chalk_brick_stairs",
			new StairsBlock(MOSSY_BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICKS = registerBlock("cracked_mossy_bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_mossy_bronze_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_mossy_bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_mossy_bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_MOSSY_BRONZE_FANCY_CHALK_BRICK_WALL)
	...
	public static final Block OVERGROWN_BRONZE_FANCY_CHALK_BRICKS = registerBlock("overgrown_bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_bronze_fancy_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICKS = registerBlock("cracked_overgrown_bronze_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_bronze_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_overgrown_bronze_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_overgrown_bronze_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_BRONZE_FANCY_CHALK_BRICK_WALL)
	...
	public static final Block SILVER_FANCY_CHALK_BRICKS = registerBlock("silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock("silver_fancy_chalk_brick_stairs",
			new StairsBlock(SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_SILVER_FANCY_CHALK_BRICKS = registerBlock("cracked_silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_silver_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_SILVER_FANCY_CHALK_BRICKS = registerBlock("mossy_silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_silver_fancy_chalk_brick_stairs",
			new StairsBlock(MOSSY_SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICKS = registerBlock("cracked_mossy_silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_mossy_silver_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_mossy_silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_mossy_silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_MOSSY_SILVER_FANCY_CHALK_BRICK_WALL)
	...
	public static final Block OVERGROWN_SILVER_FANCY_CHALK_BRICKS = registerBlock("overgrown_silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_silver_fancy_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICKS = registerBlock("cracked_overgrown_silver_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_silver_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_overgrown_silver_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_overgrown_silver_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_SILVER_FANCY_CHALK_BRICK_WALL)
	...
	public static final Block GOLD_FANCY_CHALK_BRICKS = registerBlock("gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock("gold_fancy_chalk_brick_stairs",
			new StairsBlock(GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_GOLD_FANCY_CHALK_BRICKS = registerBlock("cracked_gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_gold_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block MOSSY_GOLD_FANCY_CHALK_BRICKS = registerBlock("mossy_gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block MOSSY_GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_gold_fancy_chalk_brick_stairs",
			new StairsBlock(MOSSY_GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block MOSSY_GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block MOSSY_GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICKS = registerBlock("cracked_mossy_gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_mossy_gold_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_mossy_gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_mossy_gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_MOSSY_GOLD_FANCY_CHALK_BRICK_WALL)
	...
	public static final Block OVERGROWN_GOLD_FANCY_CHALK_BRICKS = registerBlock("overgrown_gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block OVERGROWN_GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_gold_fancy_chalk_brick_stairs",
			new StairsBlock(OVERGROWN_GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block OVERGROWN_GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block OVERGROWN_GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	...
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICKS = registerBlock("cracked_overgrown_gold_fancy_chalk_bricks",
			new Block(AbstractBlock.Settings.copy(Blocks.STONE)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_STAIRS = registerBlock(
			"cracked_overgrown_gold_fancy_chalk_brick_stairs",
			new StairsBlock(CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(Blocks.STONE_STAIRS)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_overgrown_gold_fancy_chalk_brick_slab",
			new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_SLAB)));
	public static final Block CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_overgrown_gold_fancy_chalk_brick_wall",
			new WallBlock(AbstractBlock.Settings.copy(Blocks.ANDESITE_WALL)));
	public static final BlockFamily CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICKS_FAMILY = BlockFamilies.register(CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_OVERGROWN_GOLD_FANCY_CHALK_BRICK_WALL)
     ...
     * ToDo: Check if the return value is necessary or if it can be void.
     *
     * @param name The name of the Block
