...
public enum ModStoneType {
    BLUESLATE(ModStoneBlocks.BLUESLATE_FAMILY, ModStoneBlocks.MOSSY_BLUESLATE_FAMILY, ModStoneBlocks.OVERGROWN_BLUESLATE_FAMILY,
            ...
            ModStoneBlocks.COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.MOSSY_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_MOSSY_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_OVERGROWN_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.MOSSY_BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_OVERGROWN_BRONZE_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.MOSSY_SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_OVERGROWN_SILVER_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.MOSSY_GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.CRACKED_OVERGROWN_GOLD_COBBLED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.MOSSY_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_OVERGROWN_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.BRONZE_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_BRONZE_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.MOSSY_BRONZE_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_BRONZE_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_BRONZE_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_OVERGROWN_BRONZE_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.SILVER_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_SILVER_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.MOSSY_SILVER_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_SILVER_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_SILVER_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_OVERGROWN_SILVER_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.GOLD_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_GOLD_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.MOSSY_GOLD_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_MOSSY_GOLD_BLUESLATE_BRICKS_FAMILY,
            ModStoneBlocks.OVERGROWN_GOLD_BLUESLATE_BRICKS_FAMILY, ModStoneBlocks.CRACKED_OVERGROWN_GOLD_BLUESLATE_BRICKS_FAMILY,
    ...
    CHALK(ModStoneBlocks.CHALK_FAMILY, ModStoneBlocks.MOSSY_CHALK_FAMILY, ModStoneBlocks.OVERGROWN_CHALK_FAMILY,
            ...
            ModStoneBlocks.CHALK_BRICKS_FAMILY, ModStoneBlocks.CRACKED_CHALK_BRICK_FAMILY,
