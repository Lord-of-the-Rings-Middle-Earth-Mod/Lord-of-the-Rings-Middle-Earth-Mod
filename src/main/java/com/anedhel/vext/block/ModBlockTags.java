...
public class ModBlockTags {
	...
	private static TagKey<Block> createModTag(String name) {
		return TagKey.of(RegistryKeys.BLOCK, Identifier.of(VExtMod.MOD_ID, name));
	}
}
