...
public class ChalkBlocks {
	...
	public static Block GLOWSTONE_POLISHED_CHALK = registerBlock("glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(GLOWSTONE_POLISHED_CHALK)
			.slab(GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();

	public static Block MOSSY_GLOWSTONE_POLISHED_CHALK = registerBlock("mossy_glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("mossy_glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_POLISHED_CHALK)
			.slab(MOSSY_GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();

	public static Block OVERGROWN_GLOWSTONE_POLISHED_CHALK = registerBlock("overgrown_glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("overgrown_glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_POLISHED_CHALK)
			.slab(OVERGROWN_GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();

	public static Block CRACKED_GLOWSTONE_POLISHED_CHALK = registerBlock("cracked_glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("cracked_glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_POLISHED_CHALK)
			.slab(CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK = registerBlock("mossy_cracked_glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("mossy_cracked_glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK)
			.slab(MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK = registerBlock("overgrown_cracked_glowstone_polished_chalk",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB = registerBlock("overgrown_cracked_glowstone_polished_chalk_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK_SLAB)
			.build();
	...
	public static ModStoneSubSet POLISHED_CHALK_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_POLISHED_CHALK_FAMILY,
			GLOWSTONE_POLISHED_CHALK_FAMILY, MOSSY_GLOWSTONE_POLISHED_CHALK_FAMILY, OVERGROWN_GLOWSTONE_POLISHED_CHALK_FAMILY,
			CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY, MOSSY_CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_POLISHED_CHALK_FAMILY, "polished_chalk");
	...
	public static Block GLOWSTONE_CHALK_PILLAR = registerBlock("glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(GLOWSTONE_CHALK_PILLAR)
			.slab(GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();

	public static Block MOSSY_GLOWSTONE_CHALK_PILLAR = registerBlock("mossy_glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("mossy_glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_CHALK_PILLAR)
			.slab(MOSSY_GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();

	public static Block OVERGROWN_GLOWSTONE_CHALK_PILLAR = registerBlock("overgrown_glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("overgrown_glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_CHALK_PILLAR)
			.slab(OVERGROWN_GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();

	public static Block CRACKED_GLOWSTONE_CHALK_PILLAR = registerBlock("cracked_glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("cracked_glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_CHALK_PILLAR)
			.slab(CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR = registerBlock("mossy_cracked_glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("mossy_cracked_glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR)
			.slab(MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR = registerBlock("overgrown_cracked_glowstone_chalk_pillar",
			settings -> new ModPillarBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB = registerBlock("overgrown_cracked_glowstone_chalk_pillar_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR_SLAB)
			.build();
	...
	public static ModStoneSubSet CHALK_PILLAR_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_CHALK_PILLAR_FAMILY,
			GLOWSTONE_CHALK_PILLAR_FAMILY, MOSSY_GLOWSTONE_CHALK_PILLAR_FAMILY, OVERGROWN_GLOWSTONE_CHALK_PILLAR_FAMILY,
			CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY, MOSSY_CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_CHALK_PILLAR_FAMILY, "chalk_pillar");
	...
	public static Block GLOWSTONE_CHALK_FRIEZE = registerBlock("glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(GLOWSTONE_CHALK_FRIEZE)
			.slab(GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();

	public static Block MOSSY_GLOWSTONE_CHALK_FRIEZE = registerBlock("mossy_glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("mossy_glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_CHALK_FRIEZE)
			.slab(MOSSY_GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();

	public static Block OVERGROWN_GLOWSTONE_CHALK_FRIEZE = registerBlock("overgrown_glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("overgrown_glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_CHALK_FRIEZE)
			.slab(OVERGROWN_GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();

	public static Block CRACKED_GLOWSTONE_CHALK_FRIEZE = registerBlock("cracked_glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("cracked_glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_CHALK_FRIEZE)
			.slab(CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE = registerBlock("mossy_cracked_glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("mossy_cracked_glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE)
			.slab(MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE = registerBlock("overgrown_cracked_glowstone_chalk_frieze",
			settings -> new ModFriezeBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB = registerBlock("overgrown_cracked_glowstone_chalk_frieze_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE_SLAB)
			.build();
	...
	public static ModStoneSubSet CHALK_FRIEZE_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_CHALK_FRIEZE_FAMILY,
			GLOWSTONE_CHALK_FRIEZE_FAMILY, MOSSY_GLOWSTONE_CHALK_FRIEZE_FAMILY, OVERGROWN_GLOWSTONE_CHALK_FRIEZE_FAMILY,
			CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY, MOSSY_CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_CHALK_FRIEZE_FAMILY, "chalk_frieze");
	...
	public static Block GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("mossy_glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("mossy_glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("mossy_glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("overgrown_glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("overgrown_glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("overgrown_glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();

	public static Block CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("cracked_glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("cracked_glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("cracked_glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("cracked_glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("mossy_cracked_glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("mossy_cracked_glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("mossy_cracked_glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("mossy_cracked_glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS = registerBlock("overgrown_cracked_glowstone_cobbled_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS = registerBlock("overgrown_cracked_glowstone_cobbled_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB = registerBlock("overgrown_cracked_glowstone_cobbled_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_glowstone_cobbled_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICKS)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_WALL)
			.build();
	...
	public static ModStoneSubSet COBBLED_CHALK_BRICK_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_COBBLED_CHALK_BRICK_FAMILY,
			GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY, MOSSY_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY, OVERGROWN_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY,
			CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY, MOSSY_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_COBBLED_CHALK_BRICK_FAMILY, "cobbled_chalk_brick");
	...
	public static Block GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("mossy_glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("mossy_glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("mossy_glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("mossy_glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("overgrown_glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("overgrown_glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("overgrown_glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("overgrown_glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();

	public static Block CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("cracked_glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("cracked_glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("cracked_glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("cracked_glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("mossy_cracked_glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("mossy_cracked_glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("mossy_cracked_glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("mossy_cracked_glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS = registerBlock("overgrown_cracked_glowstone_rustic_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS = registerBlock("overgrown_cracked_glowstone_rustic_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB = registerBlock("overgrown_cracked_glowstone_rustic_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_glowstone_rustic_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICKS)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_WALL)
			.build();
	...
	public static ModStoneSubSet RUSTIC_CHALK_BRICK_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_RUSTIC_CHALK_BRICK_FAMILY,
			GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY, MOSSY_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY, OVERGROWN_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY,
			CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY, MOSSY_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_RUSTIC_CHALK_BRICK_FAMILY, "rustic_chalk_brick");
	...
	public static Block MOSSY_CHALK_BRICK_WALL = registerBlock("mossy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_CHISELED_CHALK_BRICK = registerBlock("mossy_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CHALK_BRICKS)
			...
			.chiseled(MOSSY_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_CHALK_BRICK_WALL = registerBlock("overgrown_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_CHISELED_CHALK_BRICK = registerBlock("overgrown_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block CRACKED_CHALK_BRICK_WALL = registerBlock("cracked_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block CRACKED_CHISELED_CHALK_BRICK = registerBlock("cracked_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily CRACKED_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_CHALK_BRICKS)
			...
			.chiseled(CRACKED_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_CRACKED_CHALK_BRICK_WALL = registerBlock("mossy_cracked_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_CRACKED_CHISELED_CHALK_BRICK = registerBlock("mossy_cracked_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_CRACKED_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_CHALK_BRICKS)
			...
			.chiseled(MOSSY_CRACKED_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_CRACKED_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_CRACKED_CHISELED_CHALK_BRICK = registerBlock(
			"overgrown_cracked_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_CRACKED_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_CRACKED_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block BRONZE_CHALK_BRICK_WALL = registerBlock("bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block BRONZE_CHISELED_CHALK_BRICK = registerBlock("bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(BRONZE_CHALK_BRICKS)
			...
			.chiseled(BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_BRONZE_CHALK_BRICK_WALL = registerBlock("mossy_bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_BRONZE_CHISELED_CHALK_BRICK = registerBlock("mossy_bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_BRONZE_CHALK_BRICKS)
			...
			.chiseled(MOSSY_BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_BRONZE_CHALK_BRICK_WALL = registerBlock("overgrown_bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_BRONZE_CHISELED_CHALK_BRICK = registerBlock(
			"overgrown_bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_BRONZE_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block CRACKED_BRONZE_CHALK_BRICK_WALL = registerBlock("cracked_bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block CRACKED_BRONZE_CHISELED_CHALK_BRICK = registerBlock("cracked_bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily CRACKED_BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_BRONZE_CHALK_BRICKS)
			...
			.chiseled(CRACKED_BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_CRACKED_BRONZE_CHALK_BRICK_WALL = registerBlock("mossy_cracked_bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_CRACKED_BRONZE_CHISELED_CHALK_BRICK = registerBlock("mossy_cracked_bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_CRACKED_BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_BRONZE_CHALK_BRICKS)
			...
			.chiseled(MOSSY_CRACKED_BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_CRACKED_BRONZE_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_bronze_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_CRACKED_BRONZE_CHISELED_CHALK_BRICK = registerBlock("overgrown_cracked_bronze_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_CRACKED_BRONZE_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_BRONZE_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_CRACKED_BRONZE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block SILVER_CHALK_BRICK_WALL = registerBlock("silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block SILVER_CHISELED_CHALK_BRICK = registerBlock("silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(SILVER_CHALK_BRICKS)
			...
			.chiseled(SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_SILVER_CHALK_BRICK_WALL = registerBlock("mossy_silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_SILVER_CHISELED_CHALK_BRICK = registerBlock("mossy_silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_SILVER_CHALK_BRICKS)
			...
			.chiseled(MOSSY_SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_SILVER_CHALK_BRICK_WALL = registerBlock("overgrown_silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_SILVER_CHISELED_CHALK_BRICK = registerBlock("overgrown_silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_SILVER_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block CRACKED_SILVER_CHALK_BRICK_WALL = registerBlock("cracked_silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block CRACKED_SILVER_CHISELED_CHALK_BRICK = registerBlock("cracked_silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily CRACKED_SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_SILVER_CHALK_BRICKS)
			...
			.chiseled(CRACKED_SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_CRACKED_SILVER_CHALK_BRICK_WALL = registerBlock("mossy_cracked_silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_CRACKED_SILVER_CHISELED_CHALK_BRICK = registerBlock("mossy_cracked_silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_CRACKED_SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_SILVER_CHALK_BRICKS)
			...
			.chiseled(MOSSY_CRACKED_SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_CRACKED_SILVER_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_silver_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_CRACKED_SILVER_CHISELED_CHALK_BRICK = registerBlock("overgrown_cracked_silver_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_CRACKED_SILVER_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_SILVER_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_CRACKED_SILVER_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block GOLD_CHALK_BRICK_WALL = registerBlock("gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block GOLD_CHISELED_CHALK_BRICK = registerBlock("gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(GOLD_CHALK_BRICKS)
			...
			.chiseled(GOLD_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_GOLD_CHALK_BRICK_WALL = registerBlock("mossy_gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_GOLD_CHISELED_CHALK_BRICK = registerBlock("mossy_gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_GOLD_CHALK_BRICKS)
			...
			.chiseled(MOSSY_GOLD_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_GOLD_CHALK_BRICK_WALL = registerBlock("overgrown_gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_GOLD_CHISELED_CHALK_BRICK = registerBlock("overgrown_gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_GOLD_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_GOLD_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block CRACKED_GOLD_CHALK_BRICK_WALL = registerBlock("cracked_gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block CRACKED_GOLD_CHISELED_CHALK_BRICK = registerBlock("cracked_gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily CRACKED_GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_GOLD_CHALK_BRICKS)
			...
			.chiseled(CRACKED_GOLD_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block MOSSY_CRACKED_GOLD_CHALK_BRICK_WALL = registerBlock("mossy_cracked_gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block MOSSY_CRACKED_GOLD_CHISELED_CHALK_BRICK = registerBlock("mossy_cracked_gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily MOSSY_CRACKED_GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GOLD_CHALK_BRICKS)
			...
			.chiseled(MOSSY_CRACKED_GOLD_CHISELED_CHALK_BRICK)
			.build();
	...
	public static Block OVERGROWN_CRACKED_GOLD_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_gold_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static Block OVERGROWN_CRACKED_GOLD_CHISELED_CHALK_BRICK = registerBlock("overgrown_cracked_gold_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE)));
	public static BlockFamily OVERGROWN_CRACKED_GOLD_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GOLD_CHALK_BRICKS)
			...
			.chiseled(OVERGROWN_CRACKED_GOLD_CHISELED_CHALK_BRICK)
			.build();

	public static Block GLOWSTONE_CHALK_BRICKS = registerBlock("glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_BRICK_WALL = registerBlock("glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(GLOWSTONE_CHALK_BRICKS)
			.stairs(GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();

	public static Block MOSSY_GLOWSTONE_CHALK_BRICKS = registerBlock("mossy_glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("mossy_glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("mossy_glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_BRICK_WALL = registerBlock("mossy_glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("mossy_glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_CHALK_BRICKS)
			.stairs(MOSSY_GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(MOSSY_GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(MOSSY_GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(MOSSY_GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();

	public static Block OVERGROWN_GLOWSTONE_CHALK_BRICKS = registerBlock("overgrown_glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("overgrown_glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("overgrown_glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_BRICK_WALL = registerBlock("overgrown_glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("overgrown_glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_CHALK_BRICKS)
			.stairs(OVERGROWN_GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(OVERGROWN_GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();

	public static Block CRACKED_GLOWSTONE_CHALK_BRICKS = registerBlock("cracked_glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("cracked_glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("cracked_glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_BRICK_WALL = registerBlock("cracked_glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("cracked_glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_CHALK_BRICKS)
			.stairs(CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(CRACKED_GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(CRACKED_GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_BRICKS = registerBlock("mossy_cracked_glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("mossy_cracked_glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("mossy_cracked_glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_WALL = registerBlock("mossy_cracked_glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("mossy_cracked_glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_CHALK_BRICKS)
			.stairs(MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(MOSSY_CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICKS = registerBlock("overgrown_cracked_glowstone_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS = registerBlock("overgrown_cracked_glowstone_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_SLAB = registerBlock("overgrown_cracked_glowstone_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_glowstone_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK = registerBlock("overgrown_cracked_glowstone_chiseled_chalk_brick",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICKS)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_WALL)
			.chiseled(OVERGROWN_CRACKED_GLOWSTONE_CHISELED_CHALK_BRICK)
			.build();
	...
	public static ModStoneSubSet CHALK_BRICK_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_CHALK_BRICK_FAMILY,
			GLOWSTONE_CHALK_BRICK_FAMILY, MOSSY_GLOWSTONE_CHALK_BRICK_FAMILY, OVERGROWN_GLOWSTONE_CHALK_BRICK_FAMILY,
			CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY, MOSSY_CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_CHALK_BRICK_FAMILY, "chalk_brick");
	...
	public static Block GLOWSTONE_CHALK_TILES = registerBlock("glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_TILE_SLAB = registerBlock("glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_TILE_WALL = registerBlock("glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(GLOWSTONE_CHALK_TILES)
			.stairs(GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(GLOWSTONE_CHALK_TILE_SLAB)
			.wall(GLOWSTONE_CHALK_TILE_WALL)
			.build();

	public static Block MOSSY_GLOWSTONE_CHALK_TILES = registerBlock("mossy_glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("mossy_glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_TILE_SLAB = registerBlock("mossy_glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_TILE_WALL = registerBlock("mossy_glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_CHALK_TILES)
			.stairs(MOSSY_GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(MOSSY_GLOWSTONE_CHALK_TILE_SLAB)
			.wall(MOSSY_GLOWSTONE_CHALK_TILE_WALL)
			.build();

	public static Block OVERGROWN_GLOWSTONE_CHALK_TILES = registerBlock("overgrown_glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("overgrown_glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_TILE_SLAB = registerBlock("overgrown_glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_TILE_WALL = registerBlock("overgrown_glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_CHALK_TILES)
			.stairs(OVERGROWN_GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_CHALK_TILE_SLAB)
			.wall(OVERGROWN_GLOWSTONE_CHALK_TILE_WALL)
			.build();

	public static Block CRACKED_GLOWSTONE_CHALK_TILES = registerBlock("cracked_glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("cracked_glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_TILE_SLAB = registerBlock("cracked_glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_TILE_WALL = registerBlock("cracked_glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_CHALK_TILES)
			.stairs(CRACKED_GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(CRACKED_GLOWSTONE_CHALK_TILE_SLAB)
			.wall(CRACKED_GLOWSTONE_CHALK_TILE_WALL)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_TILES = registerBlock("mossy_cracked_glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("mossy_cracked_glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_SLAB = registerBlock("mossy_cracked_glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_WALL = registerBlock("mossy_cracked_glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_CHALK_TILES)
			.stairs(MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_SLAB)
			.wall(MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_WALL)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILES = registerBlock("overgrown_cracked_glowstone_chalk_tiles",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_STAIRS = registerBlock("overgrown_cracked_glowstone_chalk_tile_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILES.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_SLAB = registerBlock("overgrown_cracked_glowstone_chalk_tile_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_WALL = registerBlock("overgrown_cracked_glowstone_chalk_tile_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILES)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_SLAB)
			.wall(OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_WALL)
			.build();
	...
	public static ModStoneSubSet CHALK_TILE_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_CHALK_TILE_FAMILY,
			GLOWSTONE_CHALK_TILE_FAMILY, MOSSY_GLOWSTONE_CHALK_TILE_FAMILY, OVERGROWN_GLOWSTONE_CHALK_TILE_FAMILY,
			CRACKED_GLOWSTONE_CHALK_TILE_FAMILY, MOSSY_CRACKED_GLOWSTONE_CHALK_TILE_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_CHALK_TILE_FAMILY, "chalk_tiles");
	...
	public static Block GLOWSTONE_CHALK_PAVEMENT = registerBlock("glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(GLOWSTONE_CHALK_PAVEMENT)
			.stairs(GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();

	public static Block MOSSY_GLOWSTONE_CHALK_PAVEMENT = registerBlock("mossy_glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("mossy_glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_CHALK_PAVEMENT)
			.stairs(MOSSY_GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(MOSSY_GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();

	public static Block OVERGROWN_GLOWSTONE_CHALK_PAVEMENT = registerBlock("overgrown_glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("overgrown_glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_CHALK_PAVEMENT)
			.stairs(OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();

	public static Block CRACKED_GLOWSTONE_CHALK_PAVEMENT = registerBlock("cracked_glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("cracked_glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("cracked_glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_CHALK_PAVEMENT)
			.stairs(CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT = registerBlock("mossy_cracked_glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("mossy_cracked_glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("mossy_cracked_glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT)
			.stairs(MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT = registerBlock("overgrown_cracked_glowstone_chalk_pavement",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS = registerBlock("overgrown_cracked_glowstone_chalk_pavement_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB = registerBlock("overgrown_cracked_glowstone_chalk_pavement_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_SLAB)
			.build();
	...
	public static ModStoneSubSet CHALK_PAVEMENT_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_CHALK_PAVEMENT_FAMILY,
			GLOWSTONE_CHALK_PAVEMENT_FAMILY, MOSSY_GLOWSTONE_CHALK_PAVEMENT_FAMILY, OVERGROWN_GLOWSTONE_CHALK_PAVEMENT_FAMILY,
			CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY, MOSSY_CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_CHALK_PAVEMENT_FAMILY, "chalk_pavement");
	...
	public static Block GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("mossy_glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("overgrown_glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static Block OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 15)));
	public static BlockFamily OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();

	public static Block CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("cracked_glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("cracked_glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("cracked_glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("cracked_glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();

	public static Block MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("mossy_cracked_glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("mossy_cracked_glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("mossy_cracked_glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("mossy_cracked_glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();

	public static Block OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS = registerBlock("overgrown_cracked_glowstone_fancy_chalk_bricks",
			settings -> new Block(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS = registerBlock("overgrown_cracked_glowstone_fancy_chalk_brick_stairs",
			settings -> new StairsBlock(OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS.getDefaultState(),
					settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB = registerBlock("overgrown_cracked_glowstone_fancy_chalk_brick_slab",
			settings -> new SlabBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static Block OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL = registerBlock("overgrown_cracked_glowstone_fancy_chalk_brick_wall",
			settings -> new WallBlock(settings.strength(2.0f).requiresTool().sounds(BlockSoundGroup.STONE).luminance(state -> 7)));
	public static BlockFamily OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY = BlockFamilies.register(OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICKS)
			.stairs(OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_STAIRS)
			.slab(OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_SLAB)
			.wall(OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_WALL)
			.build();
	...
	public static ModStoneSubSet FANCY_CHALK_BRICK_SUBSET = new ModStoneSubSet(
			...
			OVERGROWN_CRACKED_GOLD_FANCY_CHALK_BRICK_FAMILY,
			GLOWSTONE_FANCY_CHALK_BRICK_FAMILY, MOSSY_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY, OVERGROWN_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY,
			CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY, MOSSY_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY,
			OVERGROWN_CRACKED_GLOWSTONE_FANCY_CHALK_BRICK_FAMILY, "fancy_chalk_brick");
