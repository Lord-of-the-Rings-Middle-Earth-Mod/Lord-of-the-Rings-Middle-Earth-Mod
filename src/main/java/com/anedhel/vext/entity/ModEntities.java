...
package com.anedhel.vext.entity;
...
public class ModEntities {
	...
	private static final RegistryKey<EntityType<?>> HOBBIT_KEY =
			RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(VExtMod.MOD_ID, "hobbit"));

	public static final EntityType<HobbitEntity> HOBBIT = Registry.register(Registries.ENTITY_TYPE,
			Identifier.of(VExtMod.MOD_ID, "hobbit"),
	...
	public static void registerModEntities() {
		VExtMod.LOGGER.info("Registering Mod Entities for " + VExtMod.MOD_ID);
	}
}
