 ...
 * @see com.anedhel.vext.screen.custom.CarpentryTableScreen
 * @see com.anedhel.vext.block.custom.CarpentryTable
 * @since 0.1.0
 */
public class CarpentryTableScreenHandler extends ScreenHandler {
	...
	public void onContentChanged(Inventory inventory) {
		...
		if (!itemStack.isOf(this.inputStack.getItem())) {
			...
			VExtMod.LOGGER.info("On Content Changed recipes found: " + this.availableRecipes.size());
		}
	}
