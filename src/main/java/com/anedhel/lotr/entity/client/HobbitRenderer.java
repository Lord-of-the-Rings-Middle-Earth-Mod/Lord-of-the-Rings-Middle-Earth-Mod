...
import com.anedhel.lotr.entity.variant.HobbitVariant;
	...
	private static final Map<HobbitVariant, Identifier> LOCATION_BY_VARIANT = Util.make(
			Maps.newEnumMap(HobbitVariant.class), map -> {
				map.put(HobbitVariant.HOBBIT_1,
						Identifier.of(LotRMEMod.MOD_ID, TEXTURE_PATH + "hobbit_1.png"));
				map.put(HobbitVariant.HOBBIT_2,
						Identifier.of(LotRMEMod.MOD_ID, TEXTURE_PATH + "hobbit_2.png"));
				map.put(HobbitVariant.HOBBIT_3,
						Identifier.of(LotRMEMod.MOD_ID, TEXTURE_PATH + "hobbit_3.png"));
			});
